...
RectVAO::RectVAO(float minXScreenSpace, float maxXScreenSpace, float minYScreenSpace, float maxYScreenSpace)
{
	...
	float vertices[] = {
		          //Position                       TexCoord
	  minXScreenSpace, minYScreenSpace,   texCoordMinX, texCoordMinY,
	  minXScreenSpace, maxYScreenSpace,   texCoordMinX, texCoordMaxY,
	  maxXScreenSpace, maxYScreenSpace,   texCoordMaxX, texCoordMaxY,
	  maxXScreenSpace, minYScreenSpace,   texCoordMaxX, texCoordMinY,
	};
