...
Renderer::Renderer(SDL_Window* window)
    : m_window(window), m_fullScreenRect(-1.0f, 1.0f, -1.0f, 1.0f), m_whatToRender(WhatToRender::FinalImage), m_bDenoiseNormals(true), m_bUseAmbientOcclusion(true), m_clearColor(0.0f, 0.066f, 0.18f, 1.0f)
{
    onWindowResize();
}
...
void Renderer::initAfterApp()
{
    ...
    setNumberOfLights(1, 1); // this compiles m_lightingPassShaderLID and #defines the number of lights
