...
App::App(SDL_Window* window)
    : m_renderer(window), m_cubesMap(71, 71, 71), m_camera(glm::vec3(0.0f)), m_lightsManager(), m_bShowImGUIDemoWindow(false), m_bAddTheSelectedSomething(false), m_window(window), m_running(true)
{
