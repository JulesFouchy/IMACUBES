...
void App::_ImGui_CameraControls()
{
    ...
    if (ImGui::BeginPopupContextItem("translation reset"))
    {
        if (ImGui::Selectable("Reset"))
            Settings::CAMERA_TRANSLATION_SPEED_PER_INCH = Settings::DEFAULT_CAMERA_TRANSLATION_SPEED_PER_INCH;
        ImGui::EndPopup();
    }
    // Rotation
    ...
    {
        if (ImGui::Selectable("Reset"))
            Settings::CAMERA_ROTATION_SPEED_IN_TURNS_PER_INCH = Settings::DEFAULT_CAMERA_ROTATION_SPEED_IN_TURNS_PER_INCH;
        ImGui::EndPopup();
    }
    // Scale
    ...
    {
        if (ImGui::Selectable("Reset"))
            Settings::CAMERA_SCALE_RADIUS_PER_SCROLL = Settings::DEFAULT_CAMERA_SCALE_RADIUS_PER_SCROLL;
        ImGui::EndPopup();
    }
}
...
void App::ImGui_RightSideWindow()
{
    ...
    if (ImGui::BeginTabBar("MyTabBar", tab_bar_flags))
    {
        ...
        {
            Locate::materialsManager().ImGui_AddMaterialToSelectedShaderButton(m_bAddTheSelectedSomething);
            ImGui::SameLine();
